...
Процедура АсинхронныеМетодыРаботаютАсинхронно() Экспорт
	...
	Поделка = Новый Поделка();
	Поделка
		.ДобавитьЖелудь(Тип("ЖелудьСАсинхроннымСеттером"))
		.ЗапуститьПриложение();

	Желудь = Поделка.НайтиЖелудь("ЖелудьСАсинхроннымСеттером");
...
&Тест
Процедура АсинхронныеМетодыВозвращаетФоновоеЗадание() Экспорт
	...
	// когда
	Результат = Желудь.УстановитьЗначениеАсинхронно(100);

	// тогда
	Ожидаем.Что(Результат, "Асинхронный метод вернул задание").ИмеетТип("ФоновоеЗадание");
